...
import { cacheSuggestions } from "../store/slice/searchSlice";
import { toggleMenu } from "../store/slice/menuToggleSlice";
...
const Head = () => {
  ...
  const searchCache: any = useSelector((store: RootState) => store.cache);
