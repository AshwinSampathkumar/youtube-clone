...
import { closeMenu } from "../../store/slice/menuToggleSlice";
import { YOUTUBE_API, YOUTUBE_VIDEO_WATCH_API } from "../../constants";
import { formatCompactNumber } from "../../utils/helper";
import LiveChat from "../../sections/watch/LiveChat";
import CommentsContainer from "../../sections/watch/CommentsContainer";
...
const WatchVideo = () => {
  ...
  const isMenuOpen = useSelector((store: RootState) => store.menu.isMenuOpen);
