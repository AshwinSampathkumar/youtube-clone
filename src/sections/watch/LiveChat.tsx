...
import { addChat } from "../../store/slice/chatSlice";
...
const LiveChat = () => {
  ...
  const chatMessages = useSelector((store: RootState) => store.chat.message);
          ...
          <form onSubmit={(e) => handleSubmit(e)}>
            <div className="flex px-3 my-2">
              ...
              <div className="px-3 w-full">
                <div className="font-medium text-[13px] text-gray-500">Ash</div>
                <input
                  value={liveMessage}
